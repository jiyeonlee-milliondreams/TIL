...
""" 깊은 복사하는 방법 (1) copy.deepcopy """
import copy
backup_catalog = copy.deepcopy(catalog)

""" 깊은 복사하는 방법 (2) 슬라이싱(원본 그대로 새로운 객체 생성) 활용하여 새로운 메모리 주소 부여하기 
